...
public class DbHelper {
    ...
    public int update(String sql, Object... params) throws SQLException {
        ...
        try {
            ...
            conn = this.getConn();
            //根据连接对象创建预编译对象
            stmt = conn.prepareStatement(sql);//对一条事务的提交是隐式事务提交
            //占位符？设置
...
//                    } else {
    ...
    public double getPloymer(String sql,Object...params)throws SQLException{
        double number=0;
        try{
            conn=getConn();
            stmt=conn.prepareStatement(sql);
